-- CNBDB - esquema operativo inicial para Club Nautico Bariloche.
-- Ejecutar con un usuario PostgreSQL con permisos para crear base:
--   psql -f sql/001_create_cnbdb.sql

CREATE DATABASE "CNBDB";
